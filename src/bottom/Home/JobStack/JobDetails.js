    ...
    <View style={style.maindashboard}>
      ...
      <View style={{ width: responsiveWidth(100), height: responsiveHeight(70), backgroundColor: colors.bg, borderTopRightRadius: responsiveWidth(20), alignItems: 'center' }}>
        <View style={{ marginTop: responsiveHeight(3) }}>
          ...
          <Animatable.Text animation={'slideInLeft'} duration={1000} style={{ marginLeft: 'auto', marginRight: 'auto', width: responsiveWidth(88), textAlign: 'left', color: colors.secondary, fontFamily: 'Poppins_500Medium', fontSize: responsiveFontSize(2.9), marginTop: responsiveFontSize(0), marginHorizontal: responsiveWidth(2) }}>{title}</Animatable.Text>
        ...
        <View style={{ marginTop: responsiveHeight(2), width: responsiveWidth(88), alignItems: 'center', justifyContent: 'space-between', flexDirection: 'row' }}>
          ...
          <Animatable.Text animation={'slideInRight'} duration={1000} style={{ textAlign: 'right', color: colors.secondary, fontFamily: 'Poppins_500Medium', fontSize: responsiveFontSize(2.1), marginTop: responsiveFontSize(0.5) }}>{mytxt}</Animatable.Text>
        </View>
