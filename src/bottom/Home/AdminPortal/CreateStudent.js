import { View, ActivityIndicator, Text, Image, StyleSheet, Alert, TouchableOpacity, ImageBackground, ScrollView, ToastAndroid, TextInput, Animated, Keyboard } from 'react-native'
...
const CreateStudent = (props) => {
    ...
    const saveLoginData = async () => {
        ...
        console.log(data)
        try {
            const response = await axios.post('https://gujarat-app.onrender.com/api/v1/admin/addStudent', data);
            console.log(response.data.newStudent.registrationNumber);
            // setId(response.data.registrationNumber);
            let registrationNu = response.data.newStudent.registrationNumber;
                ...
                <View style={Styles.screen_bg}>
                    ...
                    <View style={{ width: responsiveWidth(90) }}>
                        <View style={{ flexDirection: 'row', alignContent: 'center' }}>
                            ...
                            <Animatable.Text animation={'fadeIn'} duration={1000} style={[Styles.heading1]}>Create Student Profile</Animatable.Text>
                        </View>
                        ...
                        <ScrollView showsVerticalScrollIndicator={false} style={{
                            height: responsiveHeight(60), width: responsiveWidth(88),marginLeft:'auto',marginRight:'auto'
                        }}>
                            ...
                            <View style={[Styles.card_small]}>
                                ...
                                <TextInput placeholderTextColor={colors.secondary3} cursorColor={colors.secondary} onChangeText={(text) => setPn(text)} value={pn} placeholder="Phone Number" style={[Styles.card_small_txt, { width: responsiveWidth(77) }]} />
                                {/* <TouchableOpacity><Text style={[Styles.butText, { color: '#4294ff' }]} >forgot</Text></TouchableOpacity> */}
                            </View>
                            ...
                            <View style={[Styles.card_small]}>
                                ...
                                <TextInput placeholderTextColor={colors.secondary3} cursorColor={colors.secondary} onChangeText={(text) => setclass(text)} value={myclass} placeholder="Class" style={[Styles.card_small_txt, { width: responsiveWidth(52) }]} />
                                {/* <TouchableOpacity><Text style={[Styles.butText, { color: '#4294ff' }]} >forgot</Text></TouchableOpacity> */}
                            </View>
                            <View style={[Styles.card_small]}>
                                <Image source={require('../../../../assets/class.png')} style={Styles.card_small_img} />
                                <TextInput placeholderTextColor={colors.secondary3} cursorColor={colors.secondary} onChangeText={(text) => setsec(text)} value={sec} placeholder="Section" style={[Styles.card_small_txt, { width: responsiveWidth(52) }]} />
                                {/* <TouchableOpacity><Text style={[Styles.butText, { color: '#4294ff' }]} >forgot</Text></TouchableOpacity> */}
                            </View>
                            <View style={[Styles.card_small]}>
                                <Image source={require('../../../../assets/user.png')} style={Styles.card_small_img} />
                                <TextInput placeholderTextColor={colors.secondary3} cursorColor={colors.secondary} onChangeText={(text) => setFname(text)} value={fname} placeholder="Father's name" style={[Styles.card_small_txt, { width: responsiveWidth(52) }]} />
                                {/* <TouchableOpacity><Text style={[Styles.butText, { color: '#4294ff' }]} >forgot</Text></TouchableOpacity> */}
                            </View>
                            <View style={[Styles.card_small]}>
                                <Image source={require('../../../../assets/phone.png')} style={Styles.card_small_img} />
                                <TextInput placeholderTextColor={colors.secondary3} cursorColor={colors.secondary} onChangeText={(text) => setFphone(text)} value={fphone} placeholder="Father's Phone" style={[Styles.card_small_txt, { width: responsiveWidth(52) }]} />
                                {/* <TouchableOpacity><Text style={[Styles.butText, { color: '#4294ff' }]} >forgot</Text></TouchableOpacity> */}
                            </View>
                            <View style={[Styles.card_small]}>
                                <Image source={require('../../../../assets/policy.png')} style={Styles.card_small_img} />
                                <TextInput placeholderTextColor={colors.secondary3} cursorColor={colors.secondary} onChangeText={(text) => setCaste(text)} value={caste} placeholder="Caste" style={[Styles.card_small_txt, { width: responsiveWidth(52) }]} />
                                {/* <TouchableOpacity><Text style={[Styles.butText, { color: '#4294ff' }]} >forgot</Text></TouchableOpacity> */}
                            </View>
