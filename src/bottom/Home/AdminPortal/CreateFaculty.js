                ...
                <View style={Styles.screen_bg}>
                    ...
                    <View style={{ width: responsiveWidth(90) }}>
                        <View style={{ flexDirection: 'row', alignContent: 'center' }}>
                            ...
                            <Animatable.Text animation={'fadeIn'} duration={1000} style={[Styles.heading1]}>Create Faculty Profile</Animatable.Text>
                        </View>
                        ...
                        <Animatable.View
                            ...
                            <View style={{ padding: responsiveWidth(5), alignItems: 'center', justifyContent: 'center' }}>
                                ...
                                <View style={[Styles.card_small]}>
                                    <Image source={require('../../../../assets/policy.png')} style={Styles.card_small_img} />
                                    <TextInput placeholderTextColor={colors.secondary3} cursorColor={colors.secondary} onChangeText={(text) => setAddress(text)} value={address} placeholder="Address" style={[Styles.card_small_txt, { width: responsiveWidth(52) }]} />
                                    {/* <TouchableOpacity><Text style={[Styles.butText, { color: '#4294ff' }]} >forgot</Text></TouchableOpacity> */}
                                </View>
