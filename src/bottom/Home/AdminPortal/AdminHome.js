import { View, Text, ImageBackground, Image, StyleSheet, TextInput, TouchableOpacity, Pressable, Modal, ToastAndroid, FlatList } from 'react-native'
  ...
  return (
    <View style={Styles.full_section}>
        ...
        <ImageBackground source={{ uri: ImagesAPI[currentImageIndex].url }} resizeMode="cover" style={{ flex: 1, width: responsiveWidth(100), alignItems: 'center', }} imageStyle={{ opacity: 1, backgroundColor: colors.text_light }}>
          <View style={[{ backgroundColor: colors.shade, width: responsiveWidth(100), height: responsiveHeight(20), alignItems: 'center', borderBottomRightRadius: responsiveWidth(11), borderBottomLeftRadius: responsiveWidth(11) }]}>
            <View style={Styles.navbar}>
              ...
              <TouchableOpacity onPress={() => props.navigation.navigate('AdminProfile')}>
                <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                  <Text style={{ color: colors.bg, fontFamily: 'Poppins_500Medium', fontSize: responsiveFontSize(1.8), marginTop: responsiveFontSize(0.5), marginHorizontal: responsiveWidth(2) }}>Admin</Text>
      ...
      <View style={{ width: responsiveWidth(88), justifyContent: 'space-between', alignItems: 'center', flexDirection: 'row', marginTop: responsiveHeight(1) }}>
        ...
        <View style={{ alignItems: 'center' }}>
          <Pressable onPress={() => { props.navigation.navigate('StatusAdminStack'); }} style={({ pressed }) => [Styles.section_second_but, { elevation: pressed ? 0 : 5 }]}>
            <Image source={require('../../../../assets/status.png')} style={[Styles.butLogo]} />
          </Pressable>
          <Text style={Styles.section_sec_but_text}>
            Status
          </Text>
        ...
        <View style={{ alignItems: 'center' }}>
          <Pressable onPress={() => { setShowModal(true) }} style={({ pressed }) => [Styles.section_second_but, { elevation: pressed ? 0 : 5 }]}>
            <Image source={require('../../../../assets/add.png')} style={[Styles.butLogo]} />
          </Pressable>
          <Text style={Styles.section_sec_but_text}>
            Add
          </Text>
      ...
      <Modal transparent={true} visible={showModal} animationType='fade'>
        <View style={{ position: 'absolute', backgroundColor: '#0000008a', alignItems: 'center', justifyContent: 'center', height: responsiveHeight(100), width: responsiveWidth(100) }}>
          <View style={{ backgroundColor: 'white', width: responsiveWidth(85), borderRadius: responsiveWidth(5), paddingVertical: responsiveWidth(5), shadowColor: 'black', elevation: 10, shadowOffset: 10, shadowRadius: 10 }}>
            ...
            <Text style={{ textAlign: 'center', color: 'black', fontFamily: 'Poppins_500Medium', fontSize: responsiveFontSize(1.8), margin: responsiveWidth(3) }}>User Roles Configuration</Text>

            <View style={{ width: responsiveWidth(77), justifyContent: 'space-between', alignItems: 'center', flexDirection: 'row', marginTop: responsiveHeight(1),marginLeft:'auto',marginRight:'auto' }}>
              <View style={{ alignItems: 'center' }}>
                <Pressable onPress={() => {setShowModal(false); props.navigation.navigate('CreateAdminSide'); }} style={({ pressed }) => [Styles.section_second_but, { elevation: pressed ? 0 : 5 }]}>
                  <Image source={require('../../../../assets/add.png')} style={[Styles.butLogo,{tintColor:colors.secondary}]} />
                </Pressable>
                <Text style={Styles.section_sec_but_text}>
                  Admin
                </Text>
              ...
              <View style={{ alignItems: 'center' }}>
                <Pressable onPress={() => {setShowModal(false); props.navigation.navigate('CreateFaculty'); }} style={({ pressed }) => [Styles.section_second_but, { elevation: pressed ? 0 : 5 }]}>
                  <Image source={require('../../../../assets/add.png')} style={[Styles.butLogo,{tintColor:colors.secondary}]} />
                </Pressable>
                <Text style={Styles.section_sec_but_text}>
                  Faculty
              ...
              <View style={{ alignItems: 'center' }}>
                <Pressable onPress={() => {setShowModal(false); props.navigation.navigate('CreateStudent'); }} style={({ pressed }) => [Styles.section_second_but, { elevation: pressed ? 0 : 5 }]}>
                  <Image source={require('../../../../assets/add.png')} style={[Styles.butLogo,{tintColor:colors.secondary}]} />
                </Pressable>
                <Text style={Styles.section_sec_but_text}>
                  Student
            ...
            <View style={{ marginLeft: 'auto', marginRight: 'auto', width: responsiveWidth(75), height: responsiveWidth(12), justifyContent: 'flex-end', flexDirection: 'row', alignItems: 'center', marginTop: 20 }}>
