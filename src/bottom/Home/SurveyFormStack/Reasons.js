                ...
                <View style={Styles.screen_bg}>
                    ...
                    <View style={{ width: responsiveWidth(90) }}>
                        <View style={{ flexDirection: 'row', alignContent: 'center' }}>
                            ...
                            <Animatable.Text animation={'fadeIn'} duration={1000} style={[Styles.heading1]}>Reason of Dropout</Animatable.Text>
                        </View>
                            ...
                            <View style={{ padding: responsiveWidth(7), alignItems: 'center', justifyContent: 'center' }}>
                                <TouchableOpacity onPress={() => { districtShow() }}>
                                    <View style={Styles.card_small}>
                                        ...
                                        <TextInput editable={false} placeholderTextColor={colors.secondary3} cursorColor={colors.secondary} value={mydistrict.name} placeholder="Reason" style={Styles.card_small_txt} />
                                    </View>
                                </TouchableOpacity>
                    ...
                    {districtf ? <View style={{ height: responsiveHeight(17), width: responsiveWidth(88), borderRadius: responsiveWidth(9), alignItems: 'center', overflow: 'hidden', marginTop: responsiveHeight(0), backgroundColor: 'white', position: 'absolute', top: 0, marginTop: responsiveHeight(57) }}>
