...
const Personal = (props) => {
    ...
    const saveLoginData = async () => {
        ...
        console.log(data)
        try {
            const response = await axios.post('https://gujarat-app.onrender.com/api/v1/user/personal', data);
            console.log(response);
            // setId(response.data.registrationNumber);
        

            setLoad(false);
            ToastMessage('Successfully recorded.');
            props.navigation.navigate('Educational');
        }
        catch (error) {
            // console.log(error);
            setLoad(false);
                ...
                <View style={Styles.screen_bg}>
                    ...
                    <View style={{ width: responsiveWidth(90) }}>
                        <View style={{ flexDirection: 'row', alignContent: 'center' }}>
                            ...
                            <Animatable.Text animation={'fadeIn'} duration={1000} style={[Styles.heading1]}>Personal Details</Animatable.Text>
                        </View>
                        ...
                        <Animatable.View
                            ...
                            <View style={[Styles.card_small]}>
                                    ...
                                    <TextInput placeholderTextColor={colors.secondary3} cursorColor={colors.secondary} onChangeText={(text) => setName(text.toLowerCase())} value={name} placeholder="Name" style={[Styles.card_small_txt, { width: responsiveWidth(52) }]} />
                                ...
                                <View style={[Styles.card_small]}>
                                    ...
                                    <TextInput placeholderTextColor={colors.secondary3} cursorColor={colors.secondary} onChangeText={(text) => setEmail(text.toLowerCase())} value={email} placeholder="Email" style={[Styles.card_small_txt, { width: responsiveWidth(52) }]} />
                                    {/* <TouchableOpacity><Text style={[Styles.butText, { color: '#4294ff' }]} >forgot</Text></TouchableOpacity> */}
                                </View>
                                ...
                                <View style={[Styles.card_small]}>
                                    ...
                                    <TextInput placeholderTextColor={colors.secondary3} cursorColor={colors.secondary} onChangeText={(text) => setPhone(text)} value={phone} placeholder="Phone Number" style={[Styles.card_small_txt, { width: responsiveWidth(77) }]} />
                                    {/* <TouchableOpacity><Text style={[Styles.butText, { color: '#4294ff' }]} >forgot</Text></TouchableOpacity> */}
                                </View>
