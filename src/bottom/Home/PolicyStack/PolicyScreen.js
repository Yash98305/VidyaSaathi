    ...
    <View style={Styles.full_section}>
      ...
      <View style={{ backgroundColor: colors.primary2, width: responsiveWidth(100), height: responsiveHeight(30), alignItems: 'center', borderBottomRightRadius: responsiveWidth(11), borderBottomLeftRadius: responsiveWidth(11) }}>
        ...
        <View style={{ flexDirection: 'row', alignItems: 'center', marginTop: responsiveHeight(7), justifyContent: 'center' }}>
          ...
          <Animatable.Text animation={'fadeIn'} duration={1000} style={{ color: colors.bg, fontFamily: 'Poppins_500Medium', fontSize: responsiveFontSize(3.5), marginTop: responsiveFontSize(0.5), marginHorizontal: responsiveWidth(2) }}>Recent Policies</Animatable.Text>
        </View>
      </View>
      ...
      <View style={Styles.searchbox_wrap}>
        <View style={Styles.searchbox}>
          ...
          {input ?
            <TouchableOpacity onPress={() => { setInput(''); setFilterData(PolicyAPI); }}>
            ...
            <FlatList
              ...
              renderItem={({ item, index }) => (
                <View style={{ width: responsiveWidth(95), alignItems: 'center' }}>
                  <Pressable onPress={() => props.navigation.navigate('PolicyDetails', { title: item.title, location: item.location, url: item.url, discription: item.discription, cat: item.cat, dep: item.dep, link: item.link,Mystatus:item.Mystatus,mytxt:item.mytxt })}>
                    <Animatable.View
                      animation={'fadeInUp'}
                      duration={1000}
                      delay={index * 100}
