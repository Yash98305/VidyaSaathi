  ...
  return (
    <View style={Styles.full_section}>
          ...
          <View style={Styles.navbar}>
            ...
            <TouchableOpacity onPress={() => props.navigation.navigate('Profile')}>
              <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                <Text style={{ color: colors.bg, fontFamily: 'Poppins_500Medium', fontSize: responsiveFontSize(1.8), marginTop: responsiveFontSize(0.5), marginHorizontal: responsiveWidth(2) }}>Super Admin</Text>
      ...
      <View style={{ width: responsiveWidth(88), justifyContent: 'space-between', alignItems: 'center', flexDirection: 'row', marginTop: responsiveHeight(1) }}>
        ...
        <View style={{ alignItems: 'center' }}>
          <Pressable onPress={() => {props.navigation.navigate('CreateAdmin') }} style={({ pressed }) => [Styles.section_second_but, { elevation: pressed ? 0 : 5 }]}>
            <Image source={require('../../../../assets/plus.png')} style={[Styles.butLogo]} />
          </Pressable>
          <Text style={Styles.section_sec_but_text}>
            Add
          </Text>
