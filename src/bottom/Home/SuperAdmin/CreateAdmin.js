...
const CreateAdmin = (props) => {
    ...
    const saveLoginData = async () => {
        ...
        try {
            const response = await axios.post('https://gujarat-app.onrender.com/api/v1/user/addAdminByAdmin', data);
                ...
                <View style={Styles.screen_bg}>
                    ...
                    <View style={{ width: responsiveWidth(90) }}>
                        <View style={{ flexDirection: 'row', alignContent: 'center' }}>
                            ...
                            <Animatable.Text animation={'fadeIn'} duration={1000} style={[Styles.heading1]}>Add Management Faculty</Animatable.Text>
                        </View>
                        <Text style={Styles.heading2}>Please enter details to continue.</Text>
                        <Text style={Styles.heading2}> </Text>

                        {id==null?<Animatable.View
                            animation={'slideInDown'}
                            duration={1000}
                            // delay={index * 100}
                        ...
                        </Animatable.View>:<View style={[Styles.card_small]}>
                                    <Image source={require('../../../../assets/policy.png')} style={Styles.card_small_img} />
                                    <TextInput placeholderTextColor={colors.secondary3} cursorColor={colors.secondary} onChangeText={(text) => setRn(text)} value={id} placeholder="Registration Number" style={[Styles.card_small_txt, { width: responsiveWidth(52) }]} />
                                    {/* <TouchableOpacity><Text style={[Styles.butText, { color: '#4294ff' }]} >forgot</Text></TouchableOpacity> */}
                                </View>}
