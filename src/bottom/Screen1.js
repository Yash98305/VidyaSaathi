...
const Screen1 = () => {
  return (
    <View style={{flex:1,justifyContent:'center',alignItems:'center',backgroundColor:colors.secondary2}}>
      ...
      <Text style={{ color: colors.secondary3, fontFamily: 'Poppins_500Medium', fontSize: responsiveFontSize(2.5), marginTop: responsiveFontSize(0.5), marginHorizontal: responsiveWidth(2) }}>Screen 2</Text>
    </View>
  )
}
